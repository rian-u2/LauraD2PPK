...
int main( int argc, char** argv )
{
	...
	coeffset.push_back( new LauMagPhaseCoeffSet("omega(782)",		0.0405621, 	-0.517712, kFALSE, kFALSE) );
	coeffset.push_back( new LauMagPhaseCoeffSet("rho0(1450)",		0.11002, 	-2.57627, kFALSE, kFALSE) );
	coeffset.push_back( new LauMagPhaseCoeffSet("f_2(1270)", 		0.127446, 	0.798224, kFALSE, kFALSE) );
	coeffset.push_back( new LauMagPhaseCoeffSet("f'_2(1525)", 		0.16615, 	-0.919002, kFALSE, kFALSE) );
	coeffset.push_back( new LauMagPhaseCoeffSet("f_0(1370)",		0.237811, 	0.750529, kFALSE, kFALSE) );
	coeffset.push_back( new LauMagPhaseCoeffSet("f_0(1500)",		0.735218, 	0.676078, kFALSE, kFALSE) );
	coeffset.push_back( new LauMagPhaseCoeffSet("sigma0", 			0.192485, 	2.15288, kFALSE, kFALSE) );
	coeffset.push_back( new LauMagPhaseCoeffSet("f_0(980)", 		0.294726, 	2.03594, kFALSE, kFALSE) );

	coeffset.push_back( new LauMagPhaseCoeffSet("K*0(892)", 		1.01192, 	-2.61656, kFALSE, kFALSE) );
	coeffset.push_back( new LauMagPhaseCoeffSet("K*0_2(1430)",		0.0303203, 	-2.23155, kFALSE, kFALSE) );
	coeffset.push_back( new LauMagPhaseCoeffSet("K*0_0(1430)",		0.381583, 	2.19956, kFALSE, kFALSE) );
	coeffset.push_back( new LauMagPhaseCoeffSet("K*0(1410)", 		0.170124, 	-0.249594, kFALSE, kFALSE) );
	coeffset.push_back( new LauMagPhaseCoeffSet("kappa0", 			0.0427289, 	2.59478, kFALSE, kFALSE) );
