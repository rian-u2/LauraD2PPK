...
CXX      = g++
LD       = g++
CXXFLAGS = -g -O2 -Wall -Wno-unused-variable -Wextra -Wshadow -Woverloaded-virtual -Werror -fPIC
MFLAGS   = -MM
SOFLAGS  = -shared
endif
...
CXX      = g++
LD       = g++
CXXFLAGS = -g -O3 -Wall -Wno-unused-variable -Wextra -Wshadow -Woverloaded-virtual -Werror -fPIC -m64
MFLAGS   = -MM
